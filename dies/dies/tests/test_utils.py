...
class TestGetStructure(unittest.TestCase):
    def test_correct_final_output_for_final_outputs(self):
        ...
        self.assertRaises(ValueError, get_structure, 100, 10, 5, 0)
        self.assertRaises(ValueError, get_structure, 100, 10, 5, [1, 0])
        self.assertRaises(ValueError, get_structure, 100, 10, 5, [1, None])
...
TestGetStructure().test_percentual_conversion()
